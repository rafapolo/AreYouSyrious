...
_This is the fourth and last part of the Frontex timeline, on the events of 2021\. We will update it every first Sunday of the month\. Like the previous parts, it starts with the most recent entry\._
...
3. EU Ombudsman:
◆ **CASE [OI/5/2020/MHZ](https://www.ombudsman.europa.eu/en/case/en/57955) on** how Frontex deals with complaints about alleged fundamental rights breaches through its ‘Complaints Mechanism\.’ **Closed** \. [Decision](https://www.ombudsman.europa.eu/en/decision/en/143108) reached on June 15\.
...
\+ Syria Justice and Accountability Center \(SJAC\): [awaiting reply](https://syriaaccountability.org/updates/2021/01/28/sjac-calls-on-icc-prosecutor-to-investigate-crimes-against-humanity-committed-by-greece-against-refugees/) by International Criminal Court\. **Ongoing\.** Last update: January 28\.
### **SEPTEMBER**
...
**3 August:** Frontex [launches](https://frontex.europa.eu/media-centre/news/news-release/frontex-to-recruit-new-standing-corps-officers-Zvz12o) a new recruitment for entry\-level positions in the European Border and Coast Guard standing corps\. With this, the Agency plan to hire recruit about 200 basic\-level and around 100 intermediate\-level officers by 2022\. They will begin a 1 year training in January 2022, and will be ready to be deployed in 2023\.
...
**1 July:** Frontex [deploys](https://frontex.europa.eu/media-centre/news/news-release/frontex-provides-support-for-lithuania-latvia-at-their-borders-with-belarus-hqTC5M) 10 officers in Lithuania and Latvia, following a requests from the authorities of the two countries\. In this initial deployment, Frontex’s officers will support Latvia and Lithuania in border surveillance and other border management functions on the countries’ borders with Belarus\.

**OUT THIS MONTH**
- **To SAR or not To SAR\.** Statewatch has released the first two parts of a long anaylsis on Frontex, the European Border and the legal firewalls which have created blurred responsibilities regarding SAR and pushbacks\. Find them here:
...
> _\[…\]_ risk analysis and vulnerability assessment activities are not always supported by complete and good\-quality data\. 
...
Regarding the expansion in staff and budget set in motion with the 2019 Regulation and mandate, the auditors comment that Frontex budget for the coming years is “a large figure which was decided without any attempt todetermine what Frontex will need to carry out its new mandate, and without any assessment of its impact on Member States\.”
...
**>On the same day,** Lighthouse Reports [author](https://www.lighthousereports.nl/investigation/frontex-in-the-central-mediterranean/) , a series of investigations that show the level of investment and engagement of Frontex in supporting the Libyan coast guard, which is acting as Europe’s interception force\.
...
**1 March:** Frontex Management Board working groups’s own investigation ends\. The working group present its [final report](https://www.statewatch.org/media/2024/agenda_point_wg_fralo_final_report.pdf) on 13 cases of alleged pushbacks:
...
_Converted [Medium Post](https://medium.com/are-you-syrious/ays-special-frontex-and-human-rights-how-did-we-arrive-here-pt-4-2021-august-september-update-5c9935baa7d9) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
