...
_This is the fourth and last part of the Frontex timeline, on the events of 2021\. We will update it every first Sunday of the month\. As the previous parts, it starts with the most recent entry\._
...
1. Internal Management Board Working group: Ended \( [Summary](https://www.statewatch.org/observatories/frontex/frontex-under-scrutiny-inquiries-and-investigations-november-2020-onwards/frontex-management-board-working-group/) \) \. [Final report](https://www.statewatch.org/media/2024/agenda_point_wg_fralo_final_report.pdf) delivered on February 26 and released on March 1\.
2. OLAF, Anti\-Fraud European watchdog: Ongoing \(updated January 11\) \.
3. EU Ombudsman:
◆ **CASE [OI/5/2020/MHZ](https://www.ombudsman.europa.eu/en/case/en/57955) on** how Frontex deals with complaints about alleged fundamental rights breaches through its ‘Complaints Mechanism\.’ Ongoing \(updated March 24\) \.
◆ **CASE [2191/2020/VB](https://www.ombudsman.europa.eu/en/case/en/58432) on** Frontex’s failure to reply to an administrative complaint\. Decision given on April 12, 2021, but no details published\.
...
◆ **CASE [233/2021/OAM](https://www.ombudsman.europa.eu/en/case/en/58688)** on how Frontex dealt with a request for public access to documents concerning tracking data of vessels used in Frontex maritime operations\. Closed on March 30, 2021\(updated March 30\) \.
4. European Parliament Frontex Scrutiny Group\. Constitutive meeting held \(updated March 15\) \.
...
**> On the same day,** In relation to its decision to postpone the discharge of Frontex’s budget, the European Parliament approve a [resolution](https://www.europarl.europa.eu/doceo/document/TA-9-2021-0191_EN.pdf) in which it criticise some aspects of Frontex’s procedures on advance payments, invoicing and reimbursements\. However, the resolution focuses on the agency failure to respond timely and convincingly to widespread criticisms on its operations:
...
**15 April:** Frontex publishes [_Technology Foresight on Biometrics for the Future of Travel — Phase 1_](https://frontex.europa.eu/assets/Images_News/2021/Tech_Foresight_on_Biometrics_Phase_1.pdf) , first report on the tender won by Steinbeis 2i for the provision of a Technology Foresight on Biometrics for the Future of Travel\. The project [regards](https://frontex.europa.eu/media-centre/news/news-release/technology-foresight-on-biometrics-update-EVJJfZ) the impact of emerging biometric technologies on facilitating the border crossing at the EU external borders\. In this first update, you can read about the different stages of the study and the overarching methodology\.
...
[![Frontex: EU's Deportation Machine](../assets/4b11d10c0f0/overlay "Frontex: EU's Deportation Machine")](https://vimeo.com/351673775)
...
**March 23:** Media outlet euobserver reveal that a Freedom of Information request regarding detailed expenses incurred by Frontex in organising its European Border and Coast Guard Day in 2016, 2017, 2018 and 2019 was answered with entirely redacted documents\.
...
Frontex had previously released a breakdown for the European Border and Coast Guard Day 2015; 94,000 euros were spent at one restaurant over one single day\. It’s since refused to release detailed expenditure related to these events, which were discontinued after 2019\.

**March 22:** European Parliamentarians of the Budget Control Committee [decide to postpone](https://www.europarl.europa.eu/cmsdata/231341/Roll%20call%20Votes%2022-23%20March%202021.pdf) the [approval](https://www.europarl.europa.eu/doceo/document/CONT-AM-680801_EN.pdf) of Frontex’s 2019 budget, on the grounds of, among other things, concerns related to allegations of pushbacks, and investigations by OLAF, LIBE committee and EU Ombudsman\. [The Committee](https://www.europarl.europa.eu/meetdocs/2014_2019/plmrep/COMMITTEES/LIBE/AD/2021/03-22/1224507EN.pdf) :
...
**March 18:** Frontex, EFCA \(European Fisheries Control Agency\) and EMSA \(European Maritime Safety Agency\) sign a new [Tripartite Agreement](https://frontex.europa.eu/assets/Key_Documents/Working_Arrangements/WA_between_Frontex_EFCA_EMSA.pdf) , strengthening their cooperation on coast guard functions\. Among the purposes of this cooperation is maritime surveillance, within the EUROSUR framework:
...
_Converted [Medium Post](https://medium.com/are-you-syrious/ays-special-frontex-and-human-rights-how-did-we-arrive-here-part-4-april-update-4b11d10c0f0) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
